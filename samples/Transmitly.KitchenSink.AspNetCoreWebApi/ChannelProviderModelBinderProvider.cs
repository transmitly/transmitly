...
namespace Transmitly.KitchenSink.AspNetCoreWebApi
{
	sealed class ChannelProviderModelBinderProvider : IModelBinderProvider
	{
		public IModelBinder? GetBinder(ModelBinderProviderContext context)
		{
			...
			if (context.Metadata.ModelType == typeof(IReadOnlyCollection<ChannelProviderReport>))
				return new BinderTypeModelBinder(typeof(ChannelProviderHandlerModelBinder));
			return null;
		}
	}
}
