...
public interface IWhatsApp
{
	...
	IReadOnlyCollection<IWhatsAppAttachment> Attachments { get; }
	IWhatsAppLocation? Location { get; }
	IReadOnlyCollection<IWhatsAppContact> Contacts { get; }
	IWhatsAppTemplate? Template { get; }
