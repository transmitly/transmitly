...
namespace Transmitly.Verification.Configuration
{
	...
	internal sealed class ChannelVerificationContext : IChannelVerificationContext
	{
		...
		)
		{
			...
			//DeliveryReportStatusCallbackUrl = channelVerificationConfiguration.DeliveryReportCallbackUrl;
			//DeliveryReportStatusCallbackUrlResolver = channelVerificationConfiguration.DeliveryReportCallbackUrlResolver;
			Message = channelVerificationConfiguration.Message;

			ExtendedProperties = channelVerificationConfiguration.ExtendedProperties;
		}
		...
		//public Func<IChannelVerificationContext, Task<string?>>? DeliveryReportStatusCallbackUrlResolver { get; }
