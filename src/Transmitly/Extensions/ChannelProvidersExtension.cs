...
{
	public static class ChannelProvidersExtension
	{
		private const string DefaultProviderId = "Default";
#pragma warning disable IDE0060 // Remove unused parameter
		public static string GetId(this ChannelProviders channelProviders, string providerId, string? clientId = DefaultProviderId)
