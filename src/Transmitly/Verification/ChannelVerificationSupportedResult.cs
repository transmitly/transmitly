...
{
	internal sealed class ChannelVerificationSupportedResult(string channelProviderId, IReadOnlyCollection<string> channelIds) : IChannelVerificationSupportedResult
	{
