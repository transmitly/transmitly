...
{
	public sealed class ChannelVerificationValidationResult(bool isSuccessful, bool isVerified, string channelProviderId, string channelId, string recipient) : IChannelVerificationValidationResult
	{
